...
exports.createSubjectController = async (req, res) => {
  try {
    ...
    await auditAcademic(req, "CREATE", "Subject", req.params.programId, req.body);
  } catch (error) {
...
exports.updateSubjectController = async (req, res) => {
  try {
    ...
    await auditAcademic(req, "UPDATE", "Subject", req.params.id, req.body);
  } catch (error) {
    responseStatus(res, 400, "failed", error.message);
  }
};
...
exports.deleteSubjectController = async (req, res) => {
  try {
    ...
    await auditAcademic(req, "DELETE", "Subject", req.params.id);
    responseStatus(res, 200, "success", result);
  } catch (error) {
    responseStatus(res, 400, "failed", error.message);
  }
