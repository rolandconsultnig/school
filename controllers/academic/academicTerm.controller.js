...
exports.createAcademicTermController = async (req, res) => {
  try {
    ...
    await auditAcademic(req, "CREATE", "AcademicTerm", null, req.body);
  } catch (error) {
...
exports.updateAcademicTermController = async (req, res) => {
  try {
    ...
    await auditAcademic(req, "UPDATE", "AcademicTerm", req.params.id, req.body);
  } catch (error) {
    responseStatus(res, 400, "failed", error.message);
  }
};
...
exports.deleteAcademicTermController = async (req, res) => {
  try {
    ...
    await auditAcademic(req, "DELETE", "AcademicTerm", req.params.id);
    responseStatus(res, 201, "success", result);
  } catch (error) {
    responseStatus(res, 400, "failed", error.message);
  }
